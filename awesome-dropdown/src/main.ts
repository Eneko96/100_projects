...
const dropdownTitleIcon = document.querySelector(".dropdown-title-icon") as HTMLSpanElement;
const dropdownTitle = document.querySelector(".dropdown-title") as HTMLSpanElement;
const dropdownList = document.querySelector(".dropdown-list") as HTMLUListElement;
const mainButton = document.querySelector(".main-button") as HTMLButtonElement;
const floatingIcon = document.querySelector(".floating-icon") as HTMLDivElement;
